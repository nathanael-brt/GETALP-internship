#extract all the data from stress table generated by plspp (from the whisperx transcription or from the reference corpus) and generate a file by speaker inside as well as a Total data file
#---
#if 0 given as argument we compute from PLSPP, 1 from PLSPP_MFA else from the ref corpus
#---
#Total data file are generated into the directory "PLSPP_Prosodic/Total_data/"
# All other files are either in "PLSPP_Prosodic/PLSPP_data/" or "PLSPP_Prosodic/PLSPP_MFA_data/" or "PLSPP_Prosodic/Ref_data/"
#----------------------------------------------------------------------------------------------------------------------
import os
import sys
