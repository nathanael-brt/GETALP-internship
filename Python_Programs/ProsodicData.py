#extract all the data from stress table generated by plspp (from the whisperx transcription or from the reference corpus) and generate a file by speaker inside
#---
#if 0 given as argument we compute from PLSPP, 1 from PLSPP_MFA else from the ref corpus
#---
#Total data file generated into the directory "PLSPP_Prosodic/Total_data/"
